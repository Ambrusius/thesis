...
if __name__ == "__main__":
    ...
    path = '/groups/hep/kinch/H_Zg/samples_processed/MC23/Zee_deriv_136var.parquet'
    ...
    save_path = f'/groups/hep/kinch/H_Zg/samples_processed/MC23/Zee_deriv_epairs_{Num_events_to_save}_events.parquet'
